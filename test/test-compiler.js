...
pass+= C.errors.length==3?1:0;test++;
if (C.errors.length>0) pass+= C.errors[0].line==6?1:0;test++;  //找不到鍵
if (C.errors.length>1) pass+= C.errors[1].line==10?1:0;test++; //少了必要欄位
if (C.errors.length>2) pass+= C.errors[2].line==11?1:0;test++; //重覆
